function UiFeedPostToast(toastConfig, displayConfig)
    ...
    structData:SetInt64(4 * 8, BigInt(joaat(toastConfig.interactionAppId)))
    structData:SetInt64(5 * 8, BigInt(joaat(toastConfig.interactionAppEntry)))
    structData:SetInt64(6 * 8, BigInt(interaction))
    structData:SetInt64(7 * 8, BigInt(joaat(toastConfig.scriptEventChannelHash)))
    structData:SetInt64(8 * 8, toastConfig.scriptEventDatastoreId)
    structData:SetInt64(9 * 8, BigInt(joaat(toastConfig.scriptEventHashParameter)))
    ...
    structDisplay:SetInt64(4 * 8, BigInt(joaat(displayConfig.iconDictionaryHash)))
    structDisplay:SetInt64(5 * 8, BigInt(joaat(displayConfig.iconTextureHash)))
    structDisplay:SetInt64(6 * 8, BigInt(joaat(displayConfig.iconColorHash)))
...
function UiFeedPostDualLayerToast(toastConfig, displayConfig)
    ...
    structDisplay:SetInt64(4 * 8, BigInt(joaat(displayConfig.iconDictionaryHash)))
    structDisplay:SetInt64(5 * 8, BigInt(joaat(displayConfig.iconTextureHash)))
    structDisplay:SetInt64(6 * 8, BigInt(joaat(displayConfig.backgroundDictionaryHash)))
    structDisplay:SetInt64(7 * 8, BigInt(joaat(displayConfig.backgroundTextureHash)))
    structDisplay:SetInt64(8 * 8, BigInt(joaat(displayConfig.backgroundColorHash)))
